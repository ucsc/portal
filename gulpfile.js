...
/**
 * Copy .htaccess to destination folder
 */
...
/**
 * Copy api folder into destination folder
 */
gulp.task('api', function() {
    return gulp.src('./src/api/**/*.*', {base: './src'})
        .pipe(gulp.dest(env.destFolder));
});


/**
 * Copy inc folder into destination folder
 */
gulp.task('inc', function() {
    return gulp.src('./src/inc/**/*.*', {base: './src'})
        .pipe(gulp.dest(env.destFolder));
});
...
gulp.task('build', ['clean'], function() {
    ...
    gulp.start('js', 'css', 'html', 'htaccess', 'api', 'inc');
